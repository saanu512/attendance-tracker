...
function adminDashboard(){
  ...
  if(!adminCache.students.length)return `<div class="card formCard"><div class="row" style="justify-content:space-between"><b>👑 Admin Dashboard</b><div class="cloudActions"><button class="btn soft" data-act="refreshAdmin">Refresh</button><button class="btn outline" data-act="backFromAdmin">Back</button></div></div><div class="adminSyncBar">${adminSyncStatusHtml()}</div><p class="small">No student profiles have been synced to Firebase yet.</p></div>`;
  let h=`<div class="card formCard adminHero"><div class="row" style="justify-content:space-between"><div><b>👑 Admin Dashboard</b><div class="small">Complete cloud student records</div></div><button class="btn outline" data-act="backFromAdmin">Back</button></div><div class="adminSyncBar">${adminSyncStatusHtml()}</div><div class="adminSearch"><input id="adminSearch" class="input" placeholder="Search name, roll or email" oninput="filterAdminStudents(this.value)"></div></div><div id="adminStudentList">${adminStudentCards(adminCache.students)}</div>`;return h;
}
